...
public class DBSchema {
      ...
      public static String[] getCreateTableStatements() {
            return new String[] {
                        ...
                        "CREATE TABLE IF NOT EXISTS products (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, description TEXT, price REAL NOT NULL, purchase_price REAL, stock INTEGER DEFAULT 0, images TEXT, status TEXT DEFAULT 'available', created_at INTEGER NOT NULL)",
      ...
      public static String[] getDefaultDataStatements() {
            ...
            return new String[] {
                        ...
                        "INSERT OR IGNORE INTO categories (id, name, icon, created_at) VALUES (4, 'Postres', '\ud83c\udf70', "
                                    + now + ")",
                        "INSERT OR IGNORE INTO products (id, name, description, price, status, images, created_at) VALUES (1, 'Classic Burger', 'Carne res, queso, lechuga', 85.0, 'available', '[]', "
                                    + now + ")",
                        "INSERT OR IGNORE INTO products (id, name, description, price, status, images, created_at) VALUES (2, 'Mega Bacon', 'Doble carne, extra tocino', 120.0, 'available', '[]', "
                                    + now + ")",
                        "INSERT OR IGNORE INTO products (id, name, description, price, status, images, created_at) VALUES (3, 'Pepperoni Classic', 'Mucha mozzarella y pepperoni', 150.0, 'available', '[]', "
                                    + now + ")",
                        "INSERT OR IGNORE INTO products (id, name, description, price, status, images, created_at) VALUES (4, 'Bebida', 'Refresco de cola', 25.0, 'available', '[]', "
                                    + now + ")",
                        // Junctions for default products
                        "INSERT OR IGNORE INTO product_categories (product_id, category_id) VALUES (1, 1)",
                        "INSERT OR IGNORE INTO product_categories (product_id, category_id) VALUES (2, 1)",
                        "INSERT OR IGNORE INTO product_categories (product_id, category_id) VALUES (3, 2)",
                        "INSERT OR IGNORE INTO product_categories (product_id, category_id) VALUES (4, 3)"
            };
      }
}
